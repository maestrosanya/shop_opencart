	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/
            ...
            if ($this->user->hasPermission('access', 'extension/module/maestro')) {        
                $extension[] = array(
                    'name'     => $this->language->get('text_maestro'),
                    'href'     => $this->url->link('extension/module/maestro/edit', 'token=' . $this->session->data['token'], true),
                    'children' => array()       
                );                  
            }   
